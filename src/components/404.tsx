...
const Error404Page = ({ title } : { title?: string}) => {
    ...
    <div className="grid min-h-full place-items-center px-6 py-20 sm:py-24 lg:px-8">
      <div className="text-center">
        ...
        <p className="mt-6 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
          Sorry, we couldn’t find the {title?.toLowerCase() || 'page'} you’re looking for.
        </p>
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            to="/"
            className="rounded-md bg-cyan-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-500 hover:text-white/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400"
          >
            Go back home
          </Link>
