...
export default function AccountsLayout({ children }: { children?: React.ReactNode }) {
  ...
  return (
    <div className={`flex min-h-full flex-1 gap-2 items-center justify-center sm:p-6`}>
      <div className="hidden sm:flex flex-col p-8 aspect-square shadow-lg rounded-lg bg-cyan-500 items-center justify-center gap-2 w-1/2">
      ...
      <div className="w-1/2 flex-1 sm:flex-auto gap-4 flex flex-col items-center justify-center h-[100vh] sm:h-[calc(100vh-48px)] rounded-lg">
        ...
        {children ? 
          <div className="w-full h-full flex flex-col items-center sm:justify-center gap-2 px-4">{children}</div> : 
